...
contract UserSide is Ownable {
    ...
    function createAttestation(address recipient) external returns (uint64) {
        ...
        uint64 attestationId = spInstance.attest(att, "", "", "");
    ...
    function createDao(
        ...
        dao memory d1 = dao(
            ...
            _daoName,
            _daoDescription,
            _joiningThreshold * 1_000_000_000_000_000_000,
            _proposingThreshold * 1_000_000_000_000_000_000,
    ...
    function createProposal(
        ...
        proposal memory p1 = proposal(
            ...
            tempProposerId,
            _votingThreshold * 1_000_000_000_000_000_000,
            _daoId,
    ...
    function qvVoting(
        ...
        uint256 temp18 = _numTokens * 1_000_000_000_000_000_000;
        address funcCaller = _callerWalletAddress;
        uint256 tempDaoId = proposalIdtoProposal[_proposalId].daoId;
        require(
            checkMembership(tempDaoId, _callerWalletAddress),
        ...
        // );
        require(
            temp18 >= proposalIdtoProposal[_proposalId].votingThreshold &&
                temp18 <= userBalance,
            "Not enough Tokens"
        );
        bool voteSignal = hasVoted(tempUserId, _proposalId);
        ...
        //     require(!voteSignal,"User has Voted");
        // }
        govtToken.transferFrom(funcCaller, address(this), temp18);
